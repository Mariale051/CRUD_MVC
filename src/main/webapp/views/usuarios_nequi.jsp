...
<center>
        ...
        <form method="POST" action="usuario">
                <tr>
                                <th scope="row"><input type="number" name="id" value="${usuarios.getId()}" hidden required>${usuarios.getId()}</th>
                                <td><input type="text" name="name" value="${usuarios.getNombre()}" required></td>
                                
                                <td><input type="text" name="apellido" value="${usuarios.getApellido()}" required/></td>
                                <display:column>
                                <td>
                                        <select name="tipoDoc" id="tipoDoc" class="select-nequi-edit"required>
                                                <c:choose>
                                ...
                                <td><input type="text" name="numDoc" value="${usuarios.getNumDoc()}" required></td>

                                <td><input type="mail" name="email" class="email-table-nequi" value="${usuarios.getCorreo()}" required /></td>
                                
                                <td><input type="text" name="password" value="${usuarios.getPassword()}" required/></td>
                        ...
                        <td >
                                <button type="submit" name="petition" value="editUsuarioNequi" style="
