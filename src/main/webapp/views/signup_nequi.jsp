...
<div class=" container-fluid container-login-title">Registro</div>
    <div class="container-login-content">
        ...
        <select name="tipoDoc" id="tipoDoc" class="select-nequi">
            ...
            <button type="submit" name="petition" value="addUsuarioNequi" class="button-login nequi-btn">Ingresa</button>
        ...
        <div class="container">
                <div class="footer-header">
                            ...
                            <p class="p" style="color:#F2F2F2;">Bolsillo digital</p>
                                ...
                                <a href="rusuario?petition=login_nequi"class="a">Registro</a>
                </div>
                    </div>
            <div class="content">
                <div class="contact">
