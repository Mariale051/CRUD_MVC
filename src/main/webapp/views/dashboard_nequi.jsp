...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <li class="nav-item ">
            <a class="nav-link active" href="usuario?petition=listar_usu_nequi">Ver/editar usuarios</a>
        </li>
        <li class="nav-item ">
            <a class="nav-link active" href="bolsillo?petition=listar_bol_nequi">Ver/editar bolsillos</a>
        </li>
        </ul>
    </div>
</div>
                    ...
                    <!-- VENTANA MODAL CONSULTA SALDO -->
                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form action="route" method="POST">
                                    ...
                                    <button type="submit" name="accion" value="consulta_nequi" class="btn btn-secondary" data-bs-dismiss="modal">Aceptar</button>
                                </form>
                                    </div>
                                </div>
                                </div>
                     ...
                     <!-- VENTANA MODAL RETIRO SALDO -->
                            ...
                            <div class="modal fade" id="exampleModal-2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <button type="submit" name="accion" value="retiro_nequi">Aceptar</button>
                                    </form>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <!-- VENTANA MODAL RETIRO SALDO -->
                                   ...
                                   <div class="modal fade" id="exampleModal-3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       ...
                                       <div class="modal-content">
                                           ...
                                           <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                           <div class="row">
                                            <button type="submit" name="accion" value="recarga_nequi">Aceptar</button>
                                            </form>
                                           </div>
                                           </div>
                                       </div>
