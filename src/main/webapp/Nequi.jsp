<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/Nequi.css" media="screen">
        ...
        <nav class="u-align-center u-menu u-menu-one-level u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1">
              ...
              <li class="u-nav-item"><a
                  class="u-button-style u-nav-link u-text-active-palette-1-light-1 u-text-hover-palette-1-base"
                  href="Usuarios?accion=Usuario-add" style="padding: 12px 80px;">REGISTRATE</a>
              </li>
            </ul>
          </div>
            </div>
    ...
    <section class="u-clearfix u-image u-section-1" id="sec-281a" data-image-width="626" data-image-height="418">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-container-style u-grey-10 u-group u-radius-50 u-shape-round u-group-1"
          data-animation-name="flipIn" data-animation-duration="500" data-animation-direction="X"
          data-animation-delay="0" data-animation-out="0">
          <div class="u-container-layout u-container-layout-1"><span class="u-icon u-icon-rectangle u-icon-1"><svg
                class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 53 53" style=>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-12b9"></use>
              </svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                xml:space="preserve" class="u-svg-content" viewBox="0 0 53 53" x="0px" y="0px" id="svg-12b9"
		...
		c0.508,0.254,0.967,0.575,1.39,0.932c5.71-4.762,9.399-11.882,9.536-19.9C53.246,12.32,41.587,0.254,26.953,0.004z">
            ...
            <div class="u-form u-form-1">
              <form action="Usuarios" method="post">
                ...
                <input class="u-border-2 u-border-palette-1-dark-2 u-input u-input-rectangle u-radius-22" type="text"
                  id="username" name="username" class="fadeIn second" placeholder="Usuario">
                <label for="password">Contraseña:</label><br>
                <input class="u-border-2 u-border-palette-1-dark-2 u-input u-input-rectangle u-radius-22"
                  type="password" id="password" name="password" class="fadeIn third"
                ...
                <input
                  ...
                  type="submit" name="accion" value="Nequi">
              </form>
            </div>
          </div>
        </div>
